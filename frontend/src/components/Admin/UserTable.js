        ...
        <TableBody>
          {user.map((row,index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell   onClick={()=>handleBlock(row._id)} 
              variant="outlined" align="right" style={{cursor:"pointer",color:"blue",fontStyle:"oblique"}}>
                {(row.isBlocked)? 'Unblock':'Block' }
              </StyledTableCell>
              <StyledTableCell onClick={()=>handelRemove(row._id)} style={{cursor:"pointer",color:"red",fontStyle:"oblique"}} align="right">
               Remove
              </StyledTableCell>
            </StyledTableRow>
          ))}
